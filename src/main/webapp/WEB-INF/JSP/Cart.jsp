    ...
    <c:forEach var="CartItem" items="${sessionScope.cart}">
        <div class="product-box">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <fmt:formatNumber var="roundedValue"
                                      value="${CartItem.product.price*(100-CartItem.product.discount)/100}"
                                      pattern="#,##0.00"/>

                    <p><fmt:message key="shoppingcart.product.price"/>e:
                        <del>${CartItem.product.price}</del>
